...
# sys.path.insert(0, os.path.abspath(os.path.join(os.getcwd(), {HOME})))
sys.path.insert(0, f"{HOME}/maxtext")

from MaxText import train_utils
from MaxText import pyconfig
from MaxText.integration.tunix.tunix_adaptor import TunixMaxTextAdaptor, create_maxtext_to_vllm_mappings
...
def get_ref_maxtext_model(config):
  ...
  with mesh:
    ...
    tunix_model = TunixMaxTextAdaptor(
        base_model=model,
    )
