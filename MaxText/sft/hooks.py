...
class SFTTrainingHooks(TrainingHooks):
  ...
  def on_train_step_end(
    ...
    # We check against `train_step - 1` because this hook is called
    # after `train_step` has been incremented for the current
    # step.
    ...
    metrics = {
        "scalar": {
            ...
            "learning/total_weights": self.train_metadata[train_step - 1][
                "total_weights"
            ],
        }
    }
