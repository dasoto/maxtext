...
def main() -> int:
  ...
  # Use the 70b parameter model with real data and checkpointing with colocated python
  model = model_configs.llama3_1_70b_8192_iter_real_data_and_checkpointing
